...
<template>
  ...
  <base-input label="SubmittedDate" type="text" placeholder="Enter SubmittedDate" v-model="feedbackToAdd.submittedDate"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'submittedDate',
          visible: true,
          scopedSlots: { customRender: 'submittedDate' },
          sorter: true
          //sorter: (a, b) => a.submittedDate - b.submittedDate,
          //sorter: (a, b) => a.submittedDate.localeCompare(b.submittedDate),
        },
      ],
      pagination: {
        current: 1,
