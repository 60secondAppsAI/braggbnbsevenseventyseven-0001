...
<template>
  ...
  <base-input label="AvailabilityStatus" type="text" placeholder="Enter AvailabilityStatus" v-model="listingToAdd.availabilityStatus"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'availabilityStatus',
          visible: true,
          scopedSlots: { customRender: 'availabilityStatus' },
          sorter: true
          //sorter: (a, b) => a.availabilityStatus - b.availabilityStatus,
          //sorter: (a, b) => a.availabilityStatus.localeCompare(b.availabilityStatus),
        },
      ],
      pagination: {
        current: 1,
