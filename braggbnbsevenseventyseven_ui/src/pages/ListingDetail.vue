              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Price Per Night</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Availability Status</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="AvailabilityStatus" type="text" placeholder="Enter AvailabilityStatus" v-model="listingDetails.availabilityStatus"></input>
																		</div>
						</td>
														</tr>
