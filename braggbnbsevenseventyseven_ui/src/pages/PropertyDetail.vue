            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">City</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="City" type="text" placeholder="Enter City" v-model="propertyDetails.city"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Country</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Country" type="text" placeholder="Enter Country" v-model="propertyDetails.country"></input>
																		</div>
						</td>
														</tr>
